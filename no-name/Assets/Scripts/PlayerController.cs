...
{
	[SerializeField] float m_JumpForce = 750f;							// Amount of force added when the player jumps.
	[SerializeField][Range(0, 1)] private float m_CrouchSpeed = .5f;			// Amount of maxSpeed applied to crouching movement. 1 = 100%
